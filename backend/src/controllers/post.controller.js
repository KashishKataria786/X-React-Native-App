...
export const getPosts =asyncHandler (async(req,res)=>{
    const posts = await Post.find().sort({created:-1}).populate("user", "username firstName lastName profilePicture").populate({
        path:"comments",
        populate:{
            path:"user",
...
export const getUserPosts = asyncHandler(async(req,res)=>{
    ...
    const posts = await Post.find({user:user._id}).sort({created:-1}).populate("user", "username firstName lastName profilePicture").populate({
        path:"comments",
        populate:{
            path:"user",
            select:"username firstName lastName profilePicture"
